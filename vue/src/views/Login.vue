      ...
      <div style="height: calc(100vh - 50px); background-color:#f8f8f8; display: flex; align-items: center; justify-content: center;">
        <div style="width: 400px; padding: 40px; background-color:white; border-radius: 5px;">
          <div style = "display: flex; margin-bottom: 50px; font-size: 24px;">
            <div style="border-bottom: 2px solid orangered;padding-bottom: 2px;">登录</div>
            <a href="/register"><div style="margin-left: 10px; color: #333;">注册</div></a>
          </div>
        ...
        <el-form-item>
          <el-button size= "medium"style="width: 100%; background-color: orangered; border-color: #333; color: white" @click="login">登 录</el-button>
        </el-form-item> 
       </el-form>
    </div>
      </div>
